...
type Plan = { id: string };
const actions = [['Vendors', 'Find trusted vendors', Briefcase, '/vendors'], ['Hire a Planner', 'Get expert guidance', Heart, null], ['Bookings', 'Manage your bookings', CalendarBlank, '/bookings'], ['Events', 'Create and track events', CalendarBlank, '/events'], ['Honeymoon', 'Plan your dream trip', Suitcase, null], ['Media', 'Save your memories', Camera, null]] as const;
